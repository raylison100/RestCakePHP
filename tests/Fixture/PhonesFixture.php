...
class PhonesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'manufacturer' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-07 12:32:18',
                'modified' => '2018-11-07 12:32:18'
            ],
        ];
        parent::init();
    }
